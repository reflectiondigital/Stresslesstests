...
$Id: README.txt,v 1.3 2008/08/27 23:59:32 chellman Exp $
...
for new nodes, blocks, and comments for each role on your site.  It adds
a 'Defaults' tab to the Administer > Site configuration > Input formats
...
http://drupal.org/user/55991/contact
